...
for (var i = 0; i < userPost.length; i++) {
  var thePost = document.createElement('p')
  thePost.textContent= "User:"+" "+userPost[i].name+" "+"Posted:"+" "+userPost[i].post
  user.appendChild(thePost);
}
